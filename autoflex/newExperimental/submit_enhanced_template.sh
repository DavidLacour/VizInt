#!/bin/bash
#SBATCH --job-name=ARCH_NAME         # Change ARCH_NAME
#SBATCH --time=12:00:00              # Increased time for full training
...
#SBATCH --output=logs/ARCH_NAME_enhanced_%j.out    # Job ID in filename
#SBATCH --error=logs/ARCH_NAME_enhanced_%j.err

# Create logs directory if it doesn't exist
mkdir -p logs

# Configuration
ARCHITECTURE="ARCH_NAME"  # Change this
DATA_ROOT="../../../tiny-imagenet-200"
SAVE_DIR="../../../experimentalmodels"
EPOCHS=100
BATCH_SIZE=128  # Architecture-specific, will be overridden
PATIENCE=10
