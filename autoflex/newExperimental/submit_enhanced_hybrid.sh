#!/bin/bash
#SBATCH --job-name=hybrid_enhanced
...
#SBATCH --output=logs/hybrid_enhanced_%j.out
#SBATCH --error=logs/hybrid_enhanced_%j.err
...
EPOCHS=100
BATCH_SIZE=64  # Hybrid models may need smaller batch size
PATIENCE=10
