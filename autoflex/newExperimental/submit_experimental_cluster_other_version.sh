...
# Load conda and activate autoflex environment
module load gcc/11.4.0
module load python/3.11.6
source /work/scitas-share/tools/Miniconda/miniconda3/etc/profile.d/conda.sh
conda activate /scratch/izar/dlacour/VizInt/autoflex
