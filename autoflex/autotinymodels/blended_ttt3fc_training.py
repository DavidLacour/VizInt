...
def train_blended_ttt3fc_model(base_model, dataset_path="tiny-imagenet-200", model_dir="../../newModels"):
    """
    ...
    checkpoints_dir = model_dir_path / "checkpoints_blended3fc"
    best_model_dir = model_dir_path / "bestmodel_blended3fc"
