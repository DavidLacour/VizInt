#!/bin/bash
#SBATCH --job-name=autobaselines         # Change as needed
#SBATCH --time=6:00:00
...
#SBATCH --output=interactive_job_autobaselines.out    # Output log file
#SBATCH --error=interactive_job_autobaselines.err     # Error log file
