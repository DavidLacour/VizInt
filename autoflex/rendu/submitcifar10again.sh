#!/bin/bash
#SBATCH --job-name=cifar10_all2_again        # Change as needed
...
#SBATCH --output=interactive_job_cifar10_again.out    # Output log file
#SBATCH --error=interactive_job_cifar10_again.err     # Error log file
