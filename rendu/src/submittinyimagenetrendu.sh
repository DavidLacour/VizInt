#!/bin/bash
#SBATCH --job-name=tiny_funky3       # Change as needed
...
#SBATCH --output=interactive_job_tiny_funky3.out    # Output log file
#SBATCH --error=interactive_job_tiny_funky3.err     # Error log file
